          ...
          <PolygonSymbolizer>
            <Fill>
             ...
             <ogc:Function name="Recode">
              ...
              <ogc:PropertyName>valuation</ogc:PropertyName> 
                 </ogc:Function>
		 
		      <ogc:Literal>forest</ogc:Literal>
              <ogc:Literal>#2C7D2C</ogc:Literal>
               
              <ogc:Literal>meadow</ogc:Literal>         
              <ogc:Literal>#d9b530</ogc:Literal>
               
              <ogc:Literal>tillage</ogc:Literal>         
              <ogc:Literal>#b85c06</ogc:Literal> 
               
              <ogc:Literal>clearing</ogc:Literal>         
